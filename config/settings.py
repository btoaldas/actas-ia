...
OPENAI_DEFAULT_MAX_TOKENS = int(os.environ.get('OPENAI_DEFAULT_MAX_TOKENS', '4000'))
...
ANTHROPIC_DEFAULT_TEMPERATURE = float(os.environ.get('ANTHROPIC_DEFAULT_TEMPERATURE', '0.7'))
ANTHROPIC_DEFAULT_MAX_TOKENS = int(os.environ.get('ANTHROPIC_DEFAULT_MAX_TOKENS', '4000'))

# DeepSeek Configuration
DEEPSEEK_API_KEY = os.environ.get('DEEPSEEK_API_KEY', '')
DEEPSEEK_API_URL = os.environ.get('DEEPSEEK_API_URL', 'https://api.deepseek.com/v1/chat/completions')
DEEPSEEK_DEFAULT_MODEL = os.environ.get('DEEPSEEK_DEFAULT_MODEL', 'deepseek-chat')
DEEPSEEK_DEFAULT_TEMPERATURE = float(os.environ.get('DEEPSEEK_DEFAULT_TEMPERATURE', '0.7'))
DEEPSEEK_DEFAULT_MAX_TOKENS = int(os.environ.get('DEEPSEEK_DEFAULT_MAX_TOKENS', '4000'))

# Google (Gemini) Configuration
GOOGLE_API_KEY = os.environ.get('GOOGLE_API_KEY', '')
GOOGLE_API_URL = os.environ.get('GOOGLE_API_URL', 'https://generativelanguage.googleapis.com/v1beta/models')
GOOGLE_DEFAULT_MODEL = os.environ.get('GOOGLE_DEFAULT_MODEL', 'gemini-1.5-pro')
GOOGLE_DEFAULT_TEMPERATURE = float(os.environ.get('GOOGLE_DEFAULT_TEMPERATURE', '0.7'))
GOOGLE_DEFAULT_MAX_TOKENS = int(os.environ.get('GOOGLE_DEFAULT_MAX_TOKENS', '4000'))

# Groq Configuration
GROQ_API_KEY = os.environ.get('GROQ_API_KEY', '')
GROQ_API_URL = os.environ.get('GROQ_API_URL', 'https://api.groq.com/openai/v1/chat/completions')
GROQ_DEFAULT_MODEL = os.environ.get('GROQ_DEFAULT_MODEL', 'llama-3.1-70b-versatile')
GROQ_DEFAULT_TEMPERATURE = float(os.environ.get('GROQ_DEFAULT_TEMPERATURE', '0.7'))
GROQ_DEFAULT_MAX_TOKENS = int(os.environ.get('GROQ_DEFAULT_MAX_TOKENS', '4000'))

# Ollama Configuration (Local)
OLLAMA_API_KEY = os.environ.get('OLLAMA_API_KEY', 'no-key-required')
OLLAMA_API_URL = os.environ.get('OLLAMA_API_URL', 'http://localhost:11434/api/chat')
OLLAMA_DEFAULT_MODEL = os.environ.get('OLLAMA_DEFAULT_MODEL', 'llama3.2:3b')
OLLAMA_DEFAULT_TEMPERATURE = float(os.environ.get('OLLAMA_DEFAULT_TEMPERATURE', '0.7'))
OLLAMA_DEFAULT_MAX_TOKENS = int(os.environ.get('OLLAMA_DEFAULT_MAX_TOKENS', '4000'))
...
LMSTUDIO_DEFAULT_MODEL = os.environ.get('LMSTUDIO_DEFAULT_MODEL', 'lmstudio-community/Meta-Llama-3.1-8B-Instruct-GGUF')
LMSTUDIO_DEFAULT_TEMPERATURE = float(os.environ.get('LMSTUDIO_DEFAULT_TEMPERATURE', '0.7'))
LMSTUDIO_DEFAULT_MAX_TOKENS = int(os.environ.get('LMSTUDIO_DEFAULT_MAX_TOKENS', '4000'))

# Generic Provider 1 Configuration
GENERIC1_API_KEY = os.environ.get('GENERIC1_API_KEY', '')
GENERIC1_API_URL = os.environ.get('GENERIC1_API_URL', 'https://api.ejemplo1.com/v1/chat/completions')
GENERIC1_DEFAULT_MODEL = os.environ.get('GENERIC1_DEFAULT_MODEL', 'custom-model-1')
GENERIC1_DEFAULT_TEMPERATURE = float(os.environ.get('GENERIC1_DEFAULT_TEMPERATURE', '0.7'))
GENERIC1_DEFAULT_MAX_TOKENS = int(os.environ.get('GENERIC1_DEFAULT_MAX_TOKENS', '4000'))

# Generic Provider 2 Configuration
GENERIC2_API_KEY = os.environ.get('GENERIC2_API_KEY', '')
GENERIC2_API_URL = os.environ.get('GENERIC2_API_URL', 'https://api.ejemplo2.com/v1/chat/completions')
GENERIC2_DEFAULT_MODEL = os.environ.get('GENERIC2_DEFAULT_MODEL', 'custom-model-2')
GENERIC2_DEFAULT_TEMPERATURE = float(os.environ.get('GENERIC2_DEFAULT_TEMPERATURE', '0.7'))
GENERIC2_DEFAULT_MAX_TOKENS = int(os.environ.get('GENERIC2_DEFAULT_MAX_TOKENS', '4000'))