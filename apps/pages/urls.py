...
urlpatterns = [
    ...
    # Portal Ciudadano
    path('portal-ciudadano/', views.portal_ciudadano, name='portal_ciudadano'),
    path('acta/<int:pk>/', views.acta_detail, name='acta_detail'),
    path('acta/<int:pk>/pdf/', views.acta_pdf_view, name='acta_pdf_view'),
    ...
    # Reset COMPLETO del sistema (solo superadmin)
    path('admin/reset-sistema-completo/', views.reset_sistema_completo_admin, name='reset_sistema_completo'),
    ...
    path('fixed-navbar/', views.fixed_navbar, name='fixed_navbar'),
    ...
    # ========================================================================
    # SISTEMA DE ACTAS MUNICIPALES - URLs DEMO
    # ========================================================================
    
    # Gestión de Actas
    path('actas/listado/', views.actas_listado, name='actas_listado'),
    path('actas/nueva/', views.actas_nueva, name='actas_nueva'),
    
    # Procesamiento con IA
    path('ia/transcripcion/', views.actas_transcripcion, name='actas_transcripcion'),
    path('ia/analisis-texto/', views.actas_analisis_texto, name='actas_analisis_texto'),
    
    # Digitalización
    path('digitalizacion/escaneo/', views.actas_digitalizacion, name='actas_digitalizacion'),
    
    # Publicación
    path('publicacion/transparencia/', views.actas_publicacion, name='actas_publicacion'),
    
    # Reportes
    path('reportes/metricas/', views.actas_reportes, name='actas_reportes'),
    
    # Configuración
    path('administracion/configuracion/', views.actas_configuracion, name='actas_configuracion'),
    ...
    path('transparencia/indicadores/', views.transparencia_indicadores, name='transparencia_indicadores'),
    path('transparencia/estadisticas/', views.transparencia_estadisticas, name='transparencia_estadisticas'),
    path('transparencia/proyectos/', views.transparencia_proyectos, name='transparencia_proyectos'),
    
    # APIs para gráficos de transparencia
    path('api/transparencia/metricas/', views.api_transparencia_metricas, name='api_transparencia_metricas'),
    path('api/transparencia/timeline/', views.api_transparencia_timeline, name='api_transparencia_timeline'),
    path('api/transparencia/proyectos-stats/', views.api_transparencia_proyectos_stats, name='api_transparencia_proyectos_stats'),
    ...
    path('api/eventos/hoy/', views.api_eventos_hoy, name='api_eventos_hoy'),
]
