...
def test_escenario_complejo_tres_hablantes():
    ...
    # Mapear a participantes predefinidos (lógica de estructura_json_mejorada.py)
    ...
    if mapeo_correcto:
        ...
        print("   Sí, el sistema funciona perfectamente con este escenario!")
        print("   - Identifica que speaker_0 aparece primero (0.0s) → Alberto")
        print("   - Identifica que speaker_1 aparece segundo (3.5s) → María")  
        print("   - Identifica que speaker_2 aparece tercero (10.5s) → Carlos")
        print("   - Cuando speaker_0 vuelve a hablar, sigue siendo Alberto")
    else:
